                        ...
                        <div class="row">
                            <form method="POST" action="{{ route('dashboard.courses.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" class="form-control date" name="{{$locale}}[instructor]"
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <div class="form-line">
                                                    <input type="number" class="form-control date" name="cost" 
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <textarea id="tinymce" rows="3" name="{{$locale}}[about_course]"></textarea>
                                </div>
                                @endforeach
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <textarea id="tinymce" rows="3" name="{{$locale}}[about_instructor]"></textarea>
                                </div>
                                @endforeach
