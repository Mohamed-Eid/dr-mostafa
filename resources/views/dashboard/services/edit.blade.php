                        ...
                        <div class="row">
                            <form method="POST" action="{{ route('dashboard.services.update',$service) }}" enctype="multipart/form-data">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" class="form-control date" name="{{$locale}}[title]"
                                                        placeholder="@lang('site.service_title_'.$locale)" value="{{ $service->translate($locale)->title }}">
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <textarea id="tinymce" name="{{$locale}}[description]" rows="3">{{ $service->translate($locale)->description }}</textarea>
                                </div>
                                @endforeach
