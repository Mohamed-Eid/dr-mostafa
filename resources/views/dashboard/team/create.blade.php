        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <div class="row">
                            <form method="POST" action="{{ route('dashboard.members.store') }}" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" class="form-control date" name="{{$locale}}[name]"
                                                        placeholder="@lang('site.name_'.$locale)">
                                                </div>
                                            </div>
                                        </div>                                        
                                        @endforeach
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <div class="form-line">
                                                    ...
                                                    placeholder="@lang('site.job_name_'.$locale)">
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <textarea id="tinymce" rows="3" name="{{$locale}}[description]"></textarea>
                                </div>
                                @endforeach
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control date"
                                                placeholder="ُhttp://www.facebook.com" name="facebook">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control date"
                                                placeholder="ُhttp://www.twitter.com" name="twitter">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control date"
                                                placeholder="ُhttp://www.linkedin.com" name="linked_in">
                                        </div>
                                    </div>
                                </div>
